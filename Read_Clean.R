...
######## ######## ######## ######## ######## 
######## SELECTING COLUMNS, RENAMING ETC. ######## 
######## ######## ######## ######## ######## 

#POPULATION TOTAL - used only for computation below
...
#      main = "Life Expectancy/Children Per Woman")
